...
def validate_model(
    ...
    """
    validation function for ddpm.

    Args:
        model: the model to validate
        valid_loader: the validation data loader
        loss_fn: the loss function
        all_valid_loss: the list of validation losses
        T: the number of diffusion steps
        alpha_bar: the alpha bar values
        using_diffusers: whether using huggingface diffusers library components
    """
    model.eval()
    valid_loss = []
